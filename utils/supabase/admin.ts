...
// TODO this promise any is a hack. and also the keys in Price tyoe are random (the last two)
...
const copyBillingDetailsToCustomer = async (
  ...
  // Transform address to conform to AddressParam type
  ...
  const { error: updateError } = await supabaseAdmin
    .from('profiles')
    .update({
      billing_address: { ...transformedAddress },
